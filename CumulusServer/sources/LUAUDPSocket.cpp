...
LUAUDPSocket::LUAUDPSocket(Invoker& invoker,bool allowBroadcast,lua_State* pState) : _pState(pState),UDPSocket(invoker.poolThreads,invoker.sockets,allowBroadcast) {
}
