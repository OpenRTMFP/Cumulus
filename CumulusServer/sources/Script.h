...
#define SCRIPT_CRITIC(FMT, ...)		SCRIPT_LOG(Cumulus::Logger::PRIO_CRITIC,__FILE__,__LINE__,FMT, ## __VA_ARGS__)
#define SCRIPT_ERROR(FMT, ...)		SCRIPT_LOG(Cumulus::Logger::PRIO_ERROR,__FILE__,__LINE__,FMT, ## __VA_ARGS__)
#define SCRIPT_WARN(FMT, ...)		SCRIPT_LOG(Cumulus::Logger::PRIO_WARN,__FILE__,__LINE__,FMT, ## __VA_ARGS__)
#define SCRIPT_NOTE(FMT, ...)		SCRIPT_LOG(Cumulus::Logger::PRIO_NOTE,__FILE__,__LINE__,FMT, ## __VA_ARGS__)
#define SCRIPT_INFO(FMT, ...)		SCRIPT_LOG(Cumulus::Logger::PRIO_INFO,__FILE__,__LINE__,FMT, ## __VA_ARGS__)
...
#define SCRIPT_WRITE_AMF(READER,COUNT)							Script::WriteAMF(__pState,READER,COUNT);
...
#define SCRIPT_READ_UINT(DEFAULT)								(Poco::UInt32)((__results-(__args++))<=0 ? DEFAULT : (lua_isnumber(__pState,__args) ? (Poco::UInt32)lua_tonumber(__pState,__args) : DEFAULT))
#define SCRIPT_READ_INT(DEFAULT)								(Poco::Int32)((__results-(__args++))<=0 ? DEFAULT : (lua_isnumber(__pState,__args) ? (Poco::Int32)lua_tointeger(__pState,__args) : DEFAULT))
